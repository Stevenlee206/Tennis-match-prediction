...
from src.models.mlp_pytorch.model import TennisNet
from src.preprocessing.preprocessing import Preprocessing
import torch
import numpy as np
import torch.nn.functional as F
from src.models.mlp_pytorch.utils.dataset.dataset import prepare_loaders
from src.models.mlp_pytorch.utils.visualize.visualizer import plot_learning_curves, plot_hyperparameter_heatmap
            ...
            for fold_idx, (train_loader, val_loader) in enumerate(folds):
                ...
                for epoch in range(epochs):
                    ...
                    if (epoch + 1) % 10 == 0 or epoch == 0:
                        print(
                            f"    Fold {fold_idx + 1} | Epoch {epoch + 1:02d}/{epochs} | Loss: {avg_loss:.4f} | Val Acc: {acc:.4f}")
